        ...
        {loading || !data
          ...
          : data.trailers.map((t) => (
              <Link
                ...
                style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "white", border: "1px solid #edf0f3", borderRadius: 10, padding: "14px 16px", boxShadow: cardShadow, textDecoration: "none", color: "inherit" }}
              >
