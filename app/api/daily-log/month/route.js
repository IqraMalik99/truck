...
// GET /api/daily-log/month?year=YYYY&month=MM
// Returns:
//  {
...
//      summaryText   // human-readable note, especially useful for an in-progress month
//    }
//  }
export async function GET(request) {
  try {
    ...
    console.error("GET /api/daily-log/month error:", err);
    return NextResponse.json(
